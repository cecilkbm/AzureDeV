...
resource "azurerm_network_interface" "ny_nic" {
  ...
  ip_configuration {
    name                          = "internal"
    subnet_id                     = azurerm_subnet.nynic_subnet.id
...
resource "azurerm_network_interface" "boston_nic" {
  ...
  ip_configuration {
    name                          = "internal"
    subnet_id                     = azurerm_subnet.manic_subnet.id
    private_ip_address_allocation = "Dynamic"
...
resource "azurerm_network_interface" "seattle_nic" {
  ...
  ip_configuration {
    name                          = "internal"
    subnet_id                     = azurerm_subnet.wanic_subnet.id
    private_ip_address_allocation = "Dynamic"
